...
const routes = [
    ...
    //{ path: "login", component: LoginComponent },
    {
        ...
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./features/auth/auth.module */ "./src/app/features/auth/auth.module.ts")).then((m) => m.AuthModule),
    },
];
...
const log = new _logger_service__WEBPACK_IMPORTED_MODULE_3__["Logger"]("AuthenticationGuard");
...
const log = new _logger_service__WEBPACK_IMPORTED_MODULE_6__["Logger"]("AuthenticationService");
const credentialsKey = "credentials";
const userDomainKey = "userdomain";
...
let AuthenticationService = class AuthenticationService {
    constructor(http, confirmationService, router) {
        this.http = http;
     ...
     */
    login(username, password, appli1) {
            ...
            this.loginServices({
                ...
                if (err.error.error_schema === undefined) {
                    this.confirmationService.confirm({
                        ...
                        closable: true,
                        accept: () => {
                            this.login(username, password, appli1);
                        },
                    });
                    reject(err);
                }
                    ...
                    let icon = "./assets/img/Failed.png";
                    ...
                    // coba
                    let icons = "./assets/img/Failed.png";
     ...
     */
    logout() {
        const data = JSON.parse(sessionStorage.getItem(credentialsKey));
        log.debug(data.username);
        this.logoutServices(data.username).subscribe((resp) => {
...
const log = new _logger_service__WEBPACK_IMPORTED_MODULE_5__["Logger"]("InfoProdukService");
const httpOptions = {
    headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
        "Content-Type": "application/json",
        // "Operation": "login",
...
let InfoProdukService = class InfoProdukService {
    constructor(http, confirmationService) {
        this.http = http;
        this.confirmationService = confirmationService;
        this.isLoggedIn = false;
...
InfoProdukService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] },
...
const log = new _logger_service__WEBPACK_IMPORTED_MODULE_5__["Logger"]("NasabahService");
const httpOptions = {
    headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
        "Content-Type": "application/json",
        // "Operation": "login",
...
let NasabahService = class NasabahService {
    ...
    checkInNasabah(source, detail, name, cso_id, branch) {
        //getTotal(satkerId: string, idDistCoa: number, mataUang: string) {
        const body = { source, detail, name, cso_id, branch };
        return this.http
            .post(this.serverUrl + "/" + this.url, body, httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => data), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
        // return this.http
...
const routes = [
    {
        path: "login",
        loadChildren: () => __webpack_require__.e(/*! import() | login-login-module */ "login-login-module").then(__webpack_require__.bind(null, /*! ./login/login.module */ "./src/app/features/auth/login/login.module.ts")).then((m) => m.LoginModule),
    },
];
...
let CekinNasabahComponent = class CekinNasabahComponent {
    constructor(spinner, cd, confirmationService) {
        ...
        this.loadingSwipePaspor = () => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.showDialog();
            //console.log("Waited an additional 8s");
        });
    }
    ngOnChanges(changes) {
        console.log(changes);
    ...
    onShowSearchJenkel($event) {
        this.dropdownIconJenkel = "pi pi-chevron-up";
    }
    onHideSearchJenkel($event) {
        this.dropdownIconJenkel = "pi pi-chevron-down";
    }
    onHideDialogSearch($event) {
        this.styleSearchBy = src_app_core_enums_setting_constants_enum__WEBPACK_IMPORTED_MODULE_3__["SettingCodeConstants"].styleSearchByDefault;
...
CekinNasabahComponent.ctorParameters = () => [
...
let DashboardComponent = class DashboardComponent {
    constructor(router, confirmationService, infoProdukServices, nasabahServices) {
        this.router = router;
        this.confirmationService = confirmationService;
    ...
    ngOnInit() {
        this.infoProdukServices.getInfoProduk().subscribe((response) => {
            // console.log(response)
            this.listInfoProduk = lodash__WEBPACK_IMPORTED_MODULE_6__["chain"](response.output_schema)
                .groupBy("kategori")
                .map((value, key) => ({ kategori: key, products: value }))
                .value();
            this.selectedKategori = _core_enums_setting_constants_enum__WEBPACK_IMPORTED_MODULE_8__["SettingCodeConstants"].simpanan;
            console.log(this.listInfoProduk);
        }, (error) => {
            // this.loading = false;
    ...
    actionNext() {
        ...
        return new Promise((resolve, reject) => {
            this.nasabahServices
                .checkInNasabah("Info Produk", this.selected.join(', '), this.namaNasabah, this.userdomain.user_domain, this.userdomain.branch_code)
                .subscribe((resp) => {
...
let DetailChannelComponent = class DetailChannelComponent {
    constructor(router, infoProdukServices) {
        this.router = router;
        this.infoProdukServices = infoProdukServices;
        this.credentialsNasabahKey = 'nasabahCredentials';
    ...
    ngOnInit() {
        this.infoProdukServices.getInfoProduk().subscribe((response) => {
            this.listInfoProdukDefault = response.output_schema;
            // console.log(response);
            this.listInfoProduk = lodash__WEBPACK_IMPORTED_MODULE_5__["chain"](response.output_schema)
                .groupBy('kategori')
                .map((value, key) => ({ kategori: key, products: value }))
                .value();
            this.getNama();
            // get list info channel
            var channel = lodash__WEBPACK_IMPORTED_MODULE_5__["filter"](this.listInfoProdukDefault, { 'kategori': 'Channel' });
            this.listInfoChannel = lodash__WEBPACK_IMPORTED_MODULE_5__["chain"](channel)
                .groupBy('kategori')
                .map((value, key) => ({ kategori: key, products: value }))
                .value();
...
DetailChannelComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
let DetailProdukComponent = class DetailProdukComponent {
    constructor(router, infoProdukServices) {
        this.router = router;
        this.infoProdukServices = infoProdukServices;
        this.credentialsNasabahKey = "nasabahCredentials";
    ...
    ngOnInit() {
        ...
        this.infoProdukServices.getInfoProduk().subscribe((response) => {
            ...
            this.listLimitBiayaKartu = lodash__WEBPACK_IMPORTED_MODULE_6__["chain"](this.listItem.limitBiayaKartu)
                .groupBy("kartu")
                .map((value, key) => ({ kategori: key, keterangan: value }))
                .value();
            // console.log(this.listLimitBiayaKartu)
            // get list info channel
            var channel = lodash__WEBPACK_IMPORTED_MODULE_6__["filter"](this.listInfoProdukDefault, { 'kategori': 'Channel' });
            this.listInfoChannel = lodash__WEBPACK_IMPORTED_MODULE_6__["chain"](channel)
                .groupBy("kategori")
                .map((value, key) => ({ kategori: key, products: value }))
                .value();
            console.log('channel', this.listInfoChannel);
    ...
    onItemChangeTipeKartu(value) {
        console.log(" Value is : ", this.jenisKartu);
        this.changeCard();
    }
    onItemChangeJenisKartu(value) {
        this.changeCard();
    }
    onItemChangeRelationship(value) {
...
DetailProdukComponent.ctorParameters = () => [
...
let DetailVerifikasiComponent = class DetailVerifikasiComponent {
    constructor() {
        this.condition = true;
        this.change = false;
        this.isShow1 = false;
        this.isShow2 = false;
        this.loadingReader = () => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.wait(5000);
...
let InfoProdukComponent = class InfoProdukComponent {
    constructor(router, infoProdukServices, confirmationService) {
        this.router = router;
        this.infoProdukServices = infoProdukServices;
        this.confirmationService = confirmationService;
        this.list1 = [
    ...
    // dropdown initial
    initDrop() {
        const a = this.credentials.products;
        // console.log(a);
        return new Promise((resolve, reject) => {
                ...
                for (const c of a) {
                    if (c === 1) {
                        this.infoProdukServices.getInfoProduk().subscribe(response => {
                            ...
                            if (err.error.error_schema === undefined) {
                                const errorCode = err.error.error_schema.error_code;
                                const errorMessage = err.error.error_schema.error_message;
...
InfoProdukComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
...
let LayarVerifikasiComponent = class LayarVerifikasiComponent {
...
LayarVerifikasiComponent.ctorParameters = () => [
...
let VerifikasiKtpelComponent = class VerifikasiKtpelComponent {
    constructor(confirmationService) {
        this.confirmationService = confirmationService;
        this.display1 = true;
        this.display2 = false;
...
VerifikasiKtpelComponent.ctorParameters = () => [
    { type: src_app_shared_confirmdialog_confirmationservice__WEBPACK_IMPORTED_MODULE_2__["ConfirmationService"] }
];
...
let ButtonCustomDirective = class ButtonCustomDirective {
    constructor(el) {
        this.el = el;
        this.iconPos = "left";
    ...
    ngAfterViewInit() {
        ...
        if (this.icon) {
            ...
            let iconPosClass = this.iconPos == "right"
    ...
    getStyleClass() {
        ...
        let styleClass = "abc"; //this.cornerStyleClass;
        if (this.icon) {
...
ButtonCustomDirective.ctorParameters = () => [
...
let ButtonCustom = class ButtonCustom {
    constructor() {
        this.iconPos = "left";
...
let ButtonCustomModule = class ButtonCustomModule {
};
...
let AccordionCustomModule = class AccordionCustomModule {
};
...
let OgyaComponentsModule = class OgyaComponentsModule {
};
...
let TabCardComponent = class TabCardComponent {
    constructor() {
        this.active = false;
    }
};
...
let TabCardsComponent = class TabCardsComponent {
...
let UserDropdownComponent = class UserDropdownComponent {
    constructor(confirmationService, router, el) {
        this.confirmationService = confirmationService;
        this.router = router;
        this.el = el;
        this.dropdownPopoverShow = false;
    ...
    actionTo() {
        const x = document.getElementById('myP1');
...
let ConfirmDialogCustom = class ConfirmDialogCustom {
        ...
        this.subscription = this.confirmationService.requireConfirmation$.subscribe((confirmation) => {
            ...
            if (confirmation.key === this.key) {
                ...
                this.confirmationOptions = {
                    ...
                    rejectVisible: this.confirmation.rejectVisible == null
                        ? this.rejectVisible
                        : this.confirmation.rejectVisible,
                    acceptVisible: this.confirmation.acceptVisible == null
                        ? this.acceptVisible
                    ...
                    acceptButtonStyleClass: this.confirmation.acceptButtonStyleClass ||
                        this.acceptButtonStyleClass,
                    rejectButtonStyleClass: this.confirmation.rejectButtonStyleClass ||
                        this.rejectButtonStyleClass,
                    defaultFocus: this.confirmation.defaultFocus || this.defaultFocus,
                    blockScroll: this.confirmation.blockScroll === false ||
                        this.confirmation.blockScroll === true
                        ? this.confirmation.blockScroll
                        : this.blockScroll,
                    closable: this.confirmation.closable == null
                        ? this.closable
                        : this.confirmation.closable,
                };
    ...
    bindGlobalListeners() {
        if ((this.closeOnEscape && this.option('closable')) ||
            ...
            this.documentEscapeListener = this.renderer.listen("document", "keydown", (event) => {
                if (event.which == 27 && this.closeOnEscape && this.option('closable')) {
                    if (parseInt(this.container.style.zIndex) ===
                        primeng_dom__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].zindex + this.baseZIndex &&
                        this.visible) {
                        this.close(event);
                    }
                }
...
ConfirmDialogCustom.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] },
...
let ConfirmDialogCustomModule = class ConfirmDialogCustomModule {
};
...
let OgyaDialog = class OgyaDialog {
...
let OgyaDialogModule = class OgyaDialogModule {
};
...
let Dropdown = class Dropdown {
    ...
    set options(val) {
        let opts = this.optionLabel ? primeng_utils__WEBPACK_IMPORTED_MODULE_7__["ObjectUtils"].generateSelectItems(val, this.optionLabel) : val;
        this._options = opts;
    ...
    ngAfterViewChecked() {
        ...
        if (this.selectedOptionUpdated && this.itemsWrapper) {
            ...
            let selectedItem = primeng_dom__WEBPACK_IMPORTED_MODULE_6__["DomHandler"].findSingle(this.overlay, 'li.ui-state-highlight');
            if (selectedItem) {
        ...
        switch (event.toState) {
            case 'visible':
                ...
                if (this.options && this.options.length) {
                    if (!this.virtualScroll) {
                        let selectedListItem = primeng_dom__WEBPACK_IMPORTED_MODULE_6__["DomHandler"].findSingle(this.itemsWrapper, '.ui-dropdown-item.ui-state-highlight');
                        if (selectedListItem) {
        ...
        if (this.options && this.options.length) {
            if (this.group) {
                ...
                for (let optgroup of this.options) {
                    let filteredSubOptions = primeng_utils__WEBPACK_IMPORTED_MODULE_7__["FilterUtils"].filter(optgroup.items, searchFields, this.filterValue, this.filterMatchMode, this.filterLocale);
...
let OgyaDropdownModule = class OgyaDropdownModule {
};
...
let OgyaLayoutModule = class OgyaLayoutModule {
};
...
let StringFilterPipe = class StringFilterPipe {
    transform(value, q) {
        ...
        var data = value.filter(item => -1 < item['nama'].toLowerCase().indexOf(q.toLowerCase()));
        console.log(data);
        if (data.length < 1) {
            //data = _.find(value, { tma_kode_bank: q }).toString();
            data = value.filter(item => -1 < item['tma_kode_bank'].toString().toLowerCase().indexOf(q.toLowerCase()));
        }
        return data;
    }
};
...
const sessionIdKey = 'sessionId';
let EncryptionUtilService = class EncryptionUtilService {
    constructor() { }
    static encrypt(strClearText, useSession) {
        ...
        const text = pkcs7_padding__WEBPACK_IMPORTED_MODULE_3__["pad"](strClearText);
        const textBytes = aes_js__WEBPACK_IMPORTED_MODULE_2__["utils"].utf8.toBytes(text);
        // Proses enkripsi
        const aesEcb = new aes_js__WEBPACK_IMPORTED_MODULE_2__["ModeOfOperation"].ecb(key);
        ...
        let b64encoded = this.ToBase64(encryptedBytes);
        for (let i = 0; i < 2; i++) {
    ...
    static decrypt(strEncrypted, useSession) {
        // Decode dari base64
        const decodedText = this.FromBase64(strEncrypted);
        // Buat key
        let key;
        if (useSession) {
            const sessionId = sessionStorage.getItem(sessionIdKey);
        ...
        // Proses dekripsi
        const aesEcb = new aes_js__WEBPACK_IMPORTED_MODULE_2__["ModeOfOperation"].ecb(key);
        const decryptedBytes = aesEcb.decrypt(decodedText);
        // Dibalik menjadi text
        let decryptedText = aes_js__WEBPACK_IMPORTED_MODULE_2__["utils"].utf8.fromBytes(decryptedBytes);
        decryptedText = pkcs7_padding__WEBPACK_IMPORTED_MODULE_3__["unpad"](decryptedText);
        return decryptedText;
    }
    static ToBase64(u8) {
        const str = u8.reduce((acc, i) => acc += String.fromCharCode.apply(null, [i]), '');
        const base64Str = btoa(str);
        return base64Str;
    }
    static FromBase64(base64str) {
        const str = base64str.replace(/[_]/g, '/').replace(/[-]/g, '+');
        return (atob(str)
            .split('')
    ...
    static encodeBase64(rawString) {
        const byteString = aes_js__WEBPACK_IMPORTED_MODULE_2__["utils"].utf8.toBytes(rawString);
    ...
    //       .replace(/_/g, "/");
    // }
    static base64UrlfromBase64(base64) {
        return base64
            .replace(/=/g, "")
            .replace(/\+/g, "-")
            .replace(/\//g, "_");
...
let FieldFilterPipe = class FieldFilterPipe {
        ...
        setTimeout(() => {
            this.smartMessageBox({
                ...
                if (ButtonPressed === 'Close') {
                    console.log('Close');
                    this.smartMessageBoxClose();
                }
            });
        }, 500);
    }
    cancelMessageBox(content) {
        this.smartMessageBox({
            title: '',
            content: '<span style=\'font-size:18px\'> ' + content + ' </span>',
            buttons: '[Batal][OK]',
...
let StorageUtilService = class StorageUtilService {
     ...
     */
    static setItem(key, obj, global) {
        const encryptedObject = _encryption_util_service__WEBPACK_IMPORTED_MODULE_2__["EncryptionUtilService"].encrypt(JSON.stringify(obj), true);
        if (global) {
    ...
    static getItem(key, global) {
        ...
        const decodedObj = _encryption_util_service__WEBPACK_IMPORTED_MODULE_2__["EncryptionUtilService"].decrypt(rawObj, true);
...
let TimeDirective = class TimeDirective {
};
...
let ToggleActiveDirective = class ToggleActiveDirective {
    constructor() { }
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
